                ...
                @elseif (isset($friend))
                    @switch($friend->approval_status)
                        ...
                        <div class="add-btn">
                            <span>1205 followers</span>
                            <a href="{{ route('friend.delete',['id' => $friend->id]) }}" title=""
                               onclick="return confirm('Unfriend?')" data-ripple=""><i class="fa fa-check"></i>
                                Friend</a>
                        </div>
                        @break
                        @default
                        <div class="add-btn">
                            <span>1205 followers</span>
                            <a href="{{ route('friend.add',['friendId' => $user->id]) }}" title="" data-ripple="">Add
                                Friend</a>
                        </div>
                    @endswitch
                @else
                    ...
                    <div class="row merged">
                        <div class="col-lg-2 col-sm-3">
                            <div class="user-avatar" style="width: 220px;height: 250px">
                                <figure>
                                    <img src="{{ asset('storage/images/'.$user->avatar) }}" style="" alt="">
                                        <i class="fa fa-camera-retro" style="margin-bottom: 60px;"></i>
                                        <label class="fileContainer" style="background: wheat">
                                            <a style="margin-bottom: 3px;margin-right: 3px; text-decoration: none;" href="#open-modal">Edit Display Photo</a>
                                        </label>
                                </figure>
                            </div>
                        </div>
